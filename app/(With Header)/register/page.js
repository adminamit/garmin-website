    ...
    <div>
      ...
      >
        <div className="bg-white pt-8 pb-12 px-6 lg:px-12 shadow-md w-full max-w-[27em] relative">
          ...
          <div>
            <div>
              <h1 className="portal-heading">CREATE AN ACCOUNT</h1>
              {/* <p className="mt-4">
              ...
              <form onSubmit={formik.handleSubmit} className="pt-10 pb-9">
                <div className="input-wrapper">
                  ...
                  <input
                    ...
                    type="text"
                    className={`input ${
                      formik.errors.full_name && "error-input"
                    }`}
                ...
                <div className="input-wrapper">
                  ...
                  <input
                    ...
                    name="email"
                    type="email"
                    className={`input ${formik.errors.email && "error-input"}`}
                ...
                <div className="input-wrapper">
                  ...
                  <input
                    ...
                    type="email"
                    className={`input ${
                      formik.errors.emailConfirm && "error-input"
                    }`}
                ...
                <div className=" flex relative">
                  ...
                  >
                    <span className="">
                      Send me email about promotion and new products.
                    </span>
                  </label>

                  {formik.errors.promotion && (
                    <div className="error-text">{formik.errors.promotion}</div>
                  )}
                </div>
                ...
                <div className="">
                  ...
                  >
                    {!formik.isSubmitting ? <span>CREATE ACCOUNT</span> : ""}
                    {formik.isSubmitting ? (
                      <span>
                        <Loader size="small" />
                      </span>
