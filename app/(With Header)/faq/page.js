...
const Privacy = () => {
    return (
        <>
            ...
            <section className="content__section content__section--hero text-center">
            ...
            <section className="content__section">
                ...
                <details className="content__section__details" index="2">
                    <summary className="content__section__details__summary">
                        Learn More
                    </summary>
                    <div className="content__section__details__content">
            ...
            <section className="content__section">
                ...
                <details className="content__section__details" index="3">
                    <summary className="content__section__details__summary">
                        Learn More
                    </summary>
                    <div className="content__section__details__content">
