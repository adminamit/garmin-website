...
const About = () => {
  return (
    <div>
      ...
      <div className="container base base__small white">
        <div className="container container--constraint">
          ...
          <div className="g__copy g__copy--center g__copy--light !font-medium">
            <div>
              <p>
                We make products that are engineered on the inside for life on
                the outside. We do this so our customers can make the most of
                the time they spend pursuing their passions.
                <br />
                <br />
                <br />
                With more than 19,000 associates in 80 offices around the world,
                we bring GPS navigation and wearable technology to the
                automotive, aviation, marine, outdoor and fitness markets. We
                think every day is an opportunity to innovate and a chance to
                beat yesterday.
                <br />
                <br />
              </p>
                  ...
                  <div className="g__card__wrapper">
                    <div className="g__card__content">
                      ...
                      <div className="copy copy-only g__copy g__copy--center g__copy--light g__copy--primary">
                        <div>
                          <p>
                            To be an enduring company by creating superior
                            products for automotive, aviation, marine, outdoor,
                            and sports that are an essential part of our
                            customers{"'"} lives.
                            <br />
                            <br />
                          </p>
                      ...
                      <div className="copy copy-only g__copy g__copy--center g__copy--light g__copy--primary">
                        <div>
                          <p>
                            ...
                            serve, and our products will be sought after for
                            their compelling design, superior quality, and best
                            value.
                            <br />
                            <br />
                          </p>
                  ...
                  <div className="g__card__wrapper">
                    <div className="g__card__content">
                      ...
                      <div className="copy copy-only g__copy g__copy--center g__copy--light g__copy--primary">
                        <div>
                          <p>
                            The foundation of our culture is honesty, integrity,
                            and respect for associates, customers, and business
                            partners. Each associate is fully committed to
                            serving customers and fellow associates through
                            outstanding performance and accomplishing what we
                            say we will do.
                            <br />
                            <br />
                          </p>
            ...
            <div className="g__tile__copy g__copy g__copy--center g__copy--dark g__copy--primary">
              <div>
                <p>
                  ...
                  competitive compensations, generous benefits, career growth
                  opportunities, and a fun and engaging culture that encourages
        ...
        <div className="g__tile g__tile--base g__tile--half g__tile--dark g__tile--vertical-bottom g__tile--horizontal-center">
          ...
          <div className="g__tile__content">
            ...
            <div className="g__tile__copy g__copy g__copy--center g__copy--dark g__copy--primary">
              <div>
                <p>
                  We offer products with essential utility, leading-edge
                  technologies, compelling features, and exceptional ease-of-use
                  to create clear differentiators our customers appreciate and
                  desire.
                  <br />
                  <br />
                </p>
        ...
        <div className="g__tile g__tile--base g__tile--half g__tile--dark g__tile--vertical-bottom g__tile--horizontal-center">
          ...
          <div className="g__tile__content">
            ...
            <div className="g__tile__copy g__copy g__copy--center g__copy--dark g__copy--primary">
              <div>
                <p>
                  We embrace a vertically integrated business model with
                  strategic design, manufacturing, distribution, sales, and
                  support centres around the world to maximise our value to
                  customers.
                  <br />
                  <br />
                </p>
        ...
        <div className="g__tile g__tile--base g__tile--half g__tile--dark g__tile--vertical-bottom g__tile--horizontal-center">
          ...
          <div className="g__tile__content">
            ...
            <div className="g__tile__copy g__copy g__copy--center g__copy--dark g__copy--primary">
              <div>
                <p>
                  We relentlessly pursue innovation to create new products and
                  markets that lead to growth opportunities.
                  <br />
                  <br />
                </p>
              </div>
        ...
        <div className="g__tile g__tile--base g__tile--half g__tile--dark g__tile--vertical-bottom g__tile--horizontal-center">
          ...
          <div className="g__tile__content">
            ...
            <div className="g__tile__copy g__copy g__copy--center g__copy--dark g__copy--primary">
              <div>
                <p>
                  We continuously reinvest in people, facilities and equipment
                  to focus on long-term success and stability.
                  <br />
                  <br />
                </p>
              </div>
      ...
      <NewsletterSignup
        title="SIGN UP FOR NEWS FROM AMIT GROUP"
