                ...
                <div className="gh__nav__categories__items__menu__column">
                    ...
                    >
                        <Link
                            ...
                            href={`${process.env.NEXT_PUBLIC_LIVE_URL}/c/wearables-smartwatches?series=665c819716fdddb4b01efa9d`}
                        >
                            <img
                                className="gh__nav__categories__items__menu__promo-card__image"
                                src="https://static.garmincdn.com/emea/gdc/home-page/top-nav/2023/59033-topnav-large.jpg"
                                loading="lazy"
                                alt="VENU® 3 SERIES GPS FITNESS SMARTWATCHES"
                            />
                            <div className="grouping">
                                <h3 className="gh__nav__categories__items__menu__promo-card__heading">
                                    VENU<sup>®</sup> 3 SERIES GPS FITNESS
                                    SMARTWATCHES
                                </h3>
                                <div className="gh__nav__categories__items__menu__promo-card__copy">
                                    <p>
                                        Get detailed health and fitness insights
                                    </p>
                                </div>
                    ...
                    >
                        <Link
                            ...
                            href="https://www.garmin.com/en-GB/p/711538/"
                        >
                            <img
                                className="gh__nav__categories__items__menu__promo-card__image"
                                src="https://static.garmincdn.com/emea/gdc/home-page/top-nav/2023/vivofitJR3-Large.jpg"
                                loading="lazy"
                                alt="VÍVOFIT JR. 3 KIDS FITNESS TRACKERS"
                            />
                            <div className="grouping">
                                <h3 className="gh__nav__categories__items__menu__promo-card__heading">
                                    VÍVOFIT JR. 3 KIDS FITNESS TRACKERS
                                </h3>
                                <div className="gh__nav__categories__items__menu__promo-card__copy" />
                                <span className="gh__nav__categories__items__menu__promo-card__cta" />
                            </div>
