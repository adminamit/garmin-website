...
export const SportFitness = () => {
  return (
    <ItemWrapper title="SPORTS &amp; FITNESS">
      <div className="gh__nav__categories__items__menu">
        ...
        <div className="gh__nav__categories__items__menu__column">
          <div className="gh__nav__categories__items__menu__promo-card">
            <a className="vertical" href="/p/010-02641-43" target="_self">
              <img
          ...
          <div className="gh__nav__categories__items__menu__promo-card">
            <a
              ...
              href="https://www.garmin.com/en-GB/your-watch-your-way/family/18083/"
              target="_self"
              data-uw-rm-brl="PR"
              data-uw-original-href="https://www.garmin.com/en-GB/your-watch-your-way/family/18083/"
            >
              <img
                className="gh__nav__categories__items__menu__promo-card__image"
                src="https://legacy.garmin.ae/wp-content/uploads/2022/07/YWYW-vivoactiveWhite-Small-300x150-1.png"
                loading="lazy"
