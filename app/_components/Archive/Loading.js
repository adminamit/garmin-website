    ...
    return (
        <div>
            ...
            <div className="product-grid__products grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 px-4 mt-8 flex-grow-0">
                <div className="h-[500px] p-3 shadow-md">
                    <div className="animate-pulse flex flex-col space-y-4 justify-between h-full pb-8">
                        <div className="flex flex-col space-y-4">
                            <div className=" bg-slate-100 w-full h-[250px]"></div>
                            <div className="h-6 bg-slate-100 w-64"></div>
                            <div className="h-16 bg-slate-100"></div>
                        </div>

                        <div className="h-8 bg-slate-100 w-24"></div>
                    </div>
                </div>
                <div className="h-[500px] p-3 shadow-md">
                    <div className="animate-pulse flex flex-col space-y-4 justify-between h-full pb-8">
